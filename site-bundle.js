! function(e) {
    ...
    e.exports = function(e, t, n, A, m, g, b) {
        ...
        var w, _, x, E = function(e) {
            ...
            C = "Array" == t ? L.entries || O : O;
        if (C && (x = s(C.call(new e)), x !== Object.prototype && x.next && (l(x, k, !0), r || "function" == typeof x[d] || a(x, d, y))), S && O && O.name !== v && (T = !0, M = function() {
                return O.call(this)
    ...
    Object.defineProperty(t, "__esModule", {
        value: !0
    }), t.videoAutoplayTest = t.VideoFilterPropertyValues = t.VideoBackground = void 0, n(68);
    var r = n(69);
    ...
    (function(e, n) {
        ...
        function G(e, t, n, r, o) {
            e !== t && qt(t, function(i, a) {
                if (o || (o = new S), me(i)) H(e, t, a, n, G, r, o);
                else {
                    var u = r ? r(se(e, a), i, a + "", e, t, o) : void 0;
                    void 0 === u && (u = i), R(e, a, u)
                }
            }, _e)
        }
        ...
        function H(e, t, n, r, o, i, a) {
            ...
            d && (a.set(c, s), o(s, c, r, i, a), a.delete(c)), R(e, n, s)
        }
        ...
        function Z(e, t, n, r) {
            ...
            for (var i = -1, a = t.length; ++i < a;) {
                ...
                void 0 === c && (c = e[u]), o ? F(n, u, c) : j(n, u, c)
            }
            return n
        }
        ...
        var Se = 200,
            ...
            ct = /^(?:0|[1-9]\d*)$/,
            lt = {};
        lt[Je] = lt[Ke] = lt[$e] = lt[et] = lt[tt] = lt[nt] = lt[rt] = lt[ot] = lt[it] = !0, lt[Pe] = lt[Ce] = lt[Ze] = lt[je] = lt[Xe] = lt[Ie] = lt[Fe] = lt[Ne] = lt[De] = lt[Be] = lt[Ge] = lt[ze] = lt[qe] = lt[Ye] = lt[Qe] = !1;
    ...
    (function(t) {
        ...
        function o(e) {
            ...
            if ("blob:" === e.protocol) i = new u(unescape(e.pathname), {});
                ...
                i = new u(e, {});
                for (o in A) delete i[o]
            } else if ("object" === a) {
                for (o in e) o in A || (i[o] = e[o]);
        ...
        function u(e, t, n) {
            ...
            var c, l, f, p, h, v, A = y.slice(),
                m = typeof t,
                g = this,
                b = 0;
            for ("object" !== m && "string" !== m && (n = t, t = null), n && "function" != typeof n && (n = d.parse), t = o(t), l = i(e || ""), c = !l.protocol && !l.slashes, g.slashes = l.slashes || c && t.slashes, g.protocol = l.protocol || t.protocol || "", e = l.rest, l.slashes || (A[3] = [/(.*)/, "pathname"]); b < A.length; b++) p = A[b], "function" != typeof p ? (f = p[0], v = p[1], f !== f ? g[v] = e : "string" == typeof f ? ~(h = e.indexOf(f)) && ("number" == typeof p[2] ? (g[v] = e.slice(0, h), e = e.slice(h + p[2])) : (g[v] = e.slice(h), e = e.slice(0, h))) : (h = f.exec(e)) && (g[v] = h[1], e = e.slice(0, h.index)), g[v] = g[v] || (c && p[3] ? t[v] || "" : ""), p[4] && (g[v] = g[v].toLowerCase())) : e = p(e);
            n && (g.query = n(g.query)), c && t.slashes && "/" !== g.pathname.charAt(0) && ("" !== g.pathname || "" !== t.pathname) && (g.pathname = a(g.pathname, t.pathname)), "/" !== g.pathname.charAt(0) && g.hostname && (g.pathname = "/" + g.pathname), s(g.port, g.protocol) || (g.host = g.hostname, g.port = ""), g.username = g.password = "", g.auth && (p = g.auth.split(":"), g.username = p[0] || "", g.password = p[1] || ""), g.origin = g.protocol && g.host && "file:" !== g.protocol ? g.protocol + "//" + g.host : "null", g.href = g.toString()
        }
        ...
        u.prototype = {
            set: c,
            toString: l
        }, u.extractProtocol = i, u.location = o, u.trimLeft = r, u.qs = d, e.exports = u
    }).call(t, function() {
        return this
    }())
}, function(e, t) {
    ...
    (function(t) {
        ...
        function x(e, t) {
            t = O(t, e) ? [t] : S(t);
            for (var n = 0, r = t.length; null != e && n < r;) e = e[C(t[n++])];
        ...
        function j(e, t) {
            ...
            return n.cache = new(j.Cache || y), n
        }
    ...
    function o(e) {
        ...
        var E = (0, c.default)(e.querySelectorAll("img")),
            ...
            I = function() {
                ...
                f.authenticated && d.Tweak.watch(e, C), (0, A.addScrollListener)("start", R), (0, A.addScrollListener)("end", j), (0, h.default)(P)
            },
            F = function() {
                w = [], (0, A.removeScrollListener)("start", R), (0, A.removeScrollListener)("end", j)
            };
        return C(), I(), {
            destroy: F
        }
    ...
    var r = n(16),
        ...
        X = function(e, t, n) {
            return e === H && X(G, t, n), m(e), t = _(t, !0), m(n), o(U, t) ? (n.enumerable ? (o(e, N) && e[N][t] && (e[N][t] = !1), n = E(n, {
                enumerable: x(0, !1)
        ...
        ee = function(e, t) {
            if (e = w(e), t = _(t, !0), e !== H || !o(U, t) || o(G, t)) {
                var n = M(e, t);
                return !n || !o(U, t) || o(e, N) && e[N][t] || (n.enumerable = !0), n
            }
        },
        te = function(e) {
            for (var t, n = C(w(e)), r = [], i = 0; n.length > i;) o(U, t = n[i++]) || t == N || t == c || r.push(t);
            return r
        },
        ne = function(e) {
            for (var t, n = e === H, r = C(n ? G : w(e)), i = [], a = 0; r.length > a;) !o(U, t = r[a++]) || n && !o(H, t) || i.push(U[t]);
            return i
        };
    z || (R = function() {
    ...
    }), R[F][V] || n(20)(R[F], V, R[F].valueOf), d(R, "Symbol"), d(Math, "Math", !0), d(r.JSON, "JSON", !0)
}, function(e, t, n) {
    var r = n(46)("meta"),
        o = n(23),
        i = n(30),
    ...
    var i = r(n(168)),
        ...
        p = function() {
            function e(t) {
                var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                if ((0, l.default)(this, e), 1 !== t.nodeType) throw new Error("rootNode must be a DOM Node!");
                ...
                w = function(e) {
                    ...
                    (0, a.default)(t).forEach(function(n) {
                        ...
                        if (y !== n && e >= u && e < c) {
                            ...
                            var s = f[l];
                            s.classList.add("active"), y = n, v = s
                        }
        ...
        var t = void 0,
            ...
            j = function() {
                (0, p.addScrollListener)("scroll", g), (0, w.addIndexGalleryChangeListener)(L), (0, v.default)(function() {
                    (0, f.invalidateIndexSectionRectCache)(), L()
                }), window.addEventListener("load", O), window.addEventListener(b.indexEditEvents.enabled, M), window.addEventListener(b.indexEditEvents.disabled, P), window.addEventListener(b.indexEditEvents.deleted, C), window.addEventListener(b.indexEditEvents.reorder, R), u.Tweak.watch(["tweak-site-border-show", "tweak-site-border-width", "tweak-overlay-parallax-enabled", "tweak-overlay-parallax-new-math", "tweak-site-width-option", "tweak-site-width", "tweak-index-page-padding", "tweak-index-page-overlay-padding", "tweak-index-page-fullscreen", "tweak-index-page-min-height", "tweak-index-page-apply-bottom-spacing"], function() {
                    (0, f.invalidateIndexSectionRectCache)(), L(!0)
                })
            },
            I = function() {
                c(), y(), S(), L(), j(), t = new l.default({
            ...
            F = function() {
                (0, p.removeScrollListener)("scroll", g), (0, w.removeIndexGalleryChangeListener)(L), t && (t.destroy(), t = null), window.removeEventListener("load", O), window.removeEventListener(b.indexEditEvents.enabled, M), window.removeEventListener(b.indexEditEvents.disabled, P), window.removeEventListener(b.indexEditEvents.deleted, C), window.removeEventListener(b.indexEditEvents.reorder, R)
            },
            N = function() {
